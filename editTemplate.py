            ...
            if action == "FrontSide":
                ...
                try:
                    questionSoup, questionText = processIfRequired(
                        templateObject, questionKey, action=action, isQuestion=True, model=model, objects=objects, prettify=prettify)
                    if questionText:
                    ...
                    break
                try:
                    answerSoup, answerText = processIfRequired(
                        templateObject, answerKey, action=action, isQuestion=False, model=model, objects=objects, FrontHtml=frontHtml, prettify=prettify)
                    if answerText:
